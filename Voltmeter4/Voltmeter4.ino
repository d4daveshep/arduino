 ...
 * v4 add calibration against internal Vcc 
 * v4.1 remove resistor calibration factor
 * 
 **************************************************************************************/
...
void setup(){
  ...
  lcd.print("Voltmeter v4.1");   // print title message
...
void loop(){
  ...
  //  voltAverage = (voltAverage / 1023.0) * 5.0; // scale to 0 - 5 V range
  voltAverage = (voltAverage / 1023.0) * Vcc; // scale to 0 - 5 V range
